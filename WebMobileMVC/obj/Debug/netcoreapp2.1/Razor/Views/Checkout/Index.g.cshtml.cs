#pragma checksum "/Users/vlamtu/Projects/hanphuoclam/CamPhoneShop.git/WebMobileMVC/Views/Checkout/Index.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "4f5554f21308ba54193c4f3e7a2dc6f17558e98a"
// <auto-generated/>
...
#line default
#line hidden
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"4f5554f21308ba54193c4f3e7a2dc6f17558e98a", @"/Views/Checkout/Index.cshtml")]
    ...
    public class Views_Checkout_Index : global::Microsoft.AspNetCore.Mvc.Razor.RazorPage<dynamic>
    {
        ...
        public async override global::System.Threading.Tasks.Task ExecuteAsync()
        {
            ...
            WriteLiteral("\r\n");
            EndContext();
#line 2 "/Users/vlamtu/Projects/hanphuoclam/CamPhoneShop.git/WebMobileMVC/Views/Checkout/Index.cshtml"
  
    Layout = "_Layout";

#line default
#line hidden
            BeginContext(34, 4724, true);
            WriteLiteral(@"
<!-- Start Page Title -->
    ...
    <div class=""row"">
        ...
        <div class=""col-lg-10"">
            ...
            <div class=""row"">
                <div class=""col-sm-6"">
                    <div class=""form-group"">
                        <label for=""checkout-ln"">Tên khách hàng</label>
                ...
                <div class=""col-sm-6"">
                    <div class=""form-group"">
                        ...
                        <input class=""form-control"" type=""text"" id=""checkout-pho");
            WriteLiteral(@"ne"">
                    </div>
                </div>
            </div>
            <div class=""row padding-bottom-1x"">
                ...
                <div class=""col-sm-6"">
                    <div class=""form-group"">
                        <label for=""tinh-thanh"">Tỉnh/Thành</label>
                        <input class=""form-control"" type=""text"" id=""tinh-thanh"" placeholder=""Tỉnh / Thành phố"" required>
                    </div>
                </div>
                <div class=""col-sm-6"">
                    <div class=""form-group"">
                        <label for=""quan-huyen"">Quận/Huyện</label>
                        <input class=""form-control"" type=""text"" id=""quan-huyen"" placeholder=""Quận / Huyện"" required>
                    </div>");
            WriteLiteral(@"
                </div>
                <div class=""col-sm-6"">
                    <div class=""form-group"">
                        ...
                        <input class=""form-control"" type=""text"" id=""phuong-xa"" placeholder=""Phường / Xã"" required>
                    </div>
                </div>
                <div class=""col-sm-6"">
                    <div class=""form-group"">
                        <label for=""sonha-tenduong"">Số nhà, Tên đường</label>
                        <input class=""form-control"" type=""text"" id=""sonha-tenduong"" placeholder=""Số nhà cụ thể, tên đường"" required>
                    </div>
                </div>
            </div>
            <div class=""form-group"">
                <div class=""custom-control custom-checkbox"">
                    ...
                    <label class=""custom-control-label"" for=""same_address"">Sử dụng thông tin tài khoản</labe");
            WriteLiteral(@"l>
                </div>
            </div>
            <div class=""checkout-footer"">
                <div class=""column""><a class=""btn btn-outline-secondary"" href=""https://localhost:5001/cart/""><i class=""icon-arrow-left""></i><span class=""hidden-xs-down"">&nbsp;Quay lại giỏ hàng</span></a></div>
                <div class=""column""><a class=""btn btn-primary"" href=""https://localhost:5001/checkout/review""><span class=""hidden-xs-down"">Tiếp tục&nbsp;</span><i class=""icon-arrow-right""></i></a></div>
            </div>
        </div>
